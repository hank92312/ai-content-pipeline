...
for news in selected_news:
    ...
    請幫我將以下【這 1 則】{category} 領域的新聞標題，轉化為一段約 30 秒內的短影音完整腳本。
    【字數極度限制】：請確保輸出的文案口白（intro + main_content + outro）總中文字數在 100 到 120 字之間，以符合 30 秒短影音的最佳節奏！
    ...
    2. 主內容 (main_content)：將新聞重點流暢地講故事，不超過 60 字。
    3. 收尾句 (outro)：根據此新聞內容，拋出一個問題引導觀眾留言，並自然地呼籲訂閱。
    
    【配圖與特效要求】
    1. 你必須在 `visual_prompts` 陣列中提供「剛好 2 個」不同的英文生圖提示詞 (Prompts)。
    ...
    {{
        ...
        "main_content": "...",
        "outro": "...",
        "visual_prompts": ["畫面一的英文提示詞...", "畫面二的英文提示詞..."],
